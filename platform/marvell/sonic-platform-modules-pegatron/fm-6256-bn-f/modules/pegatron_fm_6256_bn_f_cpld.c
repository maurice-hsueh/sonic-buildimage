/*
 * A CPLD driver for the fm_6256_bn_f
 *
...
#undef pegatron_fm_6256_bn_f_DEBUG
#ifdef pegatron_fm_6256_bn_f_DEBUG
#define DBG(x) x
#else
#define DBG(x)
#endif /* DEBUG */
...
/* Addresses scanned for pegatron_fm_6256_bn_f_cpld
 */
...
int pegatron_fm_6256_bn_f_cpld_read(unsigned short addr, u8 reg)
{
...
EXPORT_SYMBOL(pegatron_fm_6256_bn_f_cpld_read);

int pegatron_fm_6256_bn_f_cpld_write(unsigned short addr, u8 reg, u8 val)
{
    struct list_head   *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
    int ret = -EIO;
...
EXPORT_SYMBOL(pegatron_fm_6256_bn_f_cpld_write);
             ...
             char *buf)
{
    ...
    data = pegatron_fm_6256_bn_f_cpld_read(client->addr, reg);
             ...
             const char *buf, size_t count)
{
    ...
    DBG(printk(KERN_ALERT "%s - addr: 0x%x, reg: %x, data: %x\r\n", __func__, client->addr, reg, data));
    pegatron_fm_6256_bn_f_cpld_write(client->addr, reg, data);
...
static struct attribute *pegatron_fm_6256_bn_f_cpldA_attributes[] = {
...
static struct attribute *pegatron_fm_6256_bn_f_cpldB_attributes[] = {
    &sensor_dev_attr_cpld_hw_version.dev_attr.attr,
    &sensor_dev_attr_cpld_sw_version.dev_attr.attr,
...
static struct attribute *pegatron_fm_6256_bn_f_cpldC_attributes[] = {
    &sensor_dev_attr_cpld_hw_version.dev_attr.attr,
    &sensor_dev_attr_cpld_sw_version.dev_attr.attr,
...
static const struct attribute_group pegatron_fm_6256_bn_f_cpldA_group = { .attrs = pegatron_fm_6256_bn_f_cpldA_attributes};
static const struct attribute_group pegatron_fm_6256_bn_f_cpldB_group = { .attrs = pegatron_fm_6256_bn_f_cpldB_attributes};
static const struct attribute_group pegatron_fm_6256_bn_f_cpldC_group = { .attrs = pegatron_fm_6256_bn_f_cpldC_attributes};

static void pegatron_fm_6256_bn_f_cpld_add_client(struct i2c_client *client)
{
...
static void pegatron_fm_6256_bn_f_cpld_remove_client(struct i2c_client *client)
{
    struct list_head        *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
    int found = 0;
...
static int pegatron_fm_6256_bn_f_cpld_probe(struct i2c_client *client,
...
{  
    ...
    {
        case CPLDA_ADDRESS:
            status = sysfs_create_group(&client->dev.kobj, &pegatron_fm_6256_bn_f_cpldA_group);
            break;
        case CPLDB_ADDRESS:
            status = sysfs_create_group(&client->dev.kobj, &pegatron_fm_6256_bn_f_cpldB_group);
            break;
        case CPLDC_ADDRESS:
            status = sysfs_create_group(&client->dev.kobj, &pegatron_fm_6256_bn_f_cpldC_group);
            break;
        default:
    ...
    pegatron_fm_6256_bn_f_cpld_add_client(client);
...
static int pegatron_fm_6256_bn_f_cpld_remove(struct i2c_client *client)
{
    switch(client->addr)
    {
        case CPLDA_ADDRESS:
            sysfs_remove_group(&client->dev.kobj, &pegatron_fm_6256_bn_f_cpldA_group);
            break;
        case CPLDB_ADDRESS:
            sysfs_remove_group(&client->dev.kobj, &pegatron_fm_6256_bn_f_cpldB_group);
            break;
        case CPLDC_ADDRESS:
            sysfs_remove_group(&client->dev.kobj, &pegatron_fm_6256_bn_f_cpldC_group);
            break;
        default:
    ...
    pegatron_fm_6256_bn_f_cpld_remove_client(client);  
    return 0;
}

static const struct i2c_device_id pegatron_fm_6256_bn_f_cpld_id[] = {
    { "fm_6256_bn_f_cpld", 0 },
    {}
};
MODULE_DEVICE_TABLE(i2c, pegatron_fm_6256_bn_f_cpld_id);

static struct i2c_driver pegatron_fm_6256_bn_f_cpld_driver = {
    .class      = I2C_CLASS_HWMON,
    .driver = {
        .name = "pegatron_fm_6256_bn_f_cpld",
    },
    .probe      = pegatron_fm_6256_bn_f_cpld_probe,
    .remove     = pegatron_fm_6256_bn_f_cpld_remove,
    .id_table   = pegatron_fm_6256_bn_f_cpld_id,
    .address_list = normal_i2c,
};

static int __init pegatron_fm_6256_bn_f_cpld_init(void)
{
    mutex_init(&list_lock);

    return i2c_add_driver(&pegatron_fm_6256_bn_f_cpld_driver);
}

static void __exit pegatron_fm_6256_bn_f_cpld_exit(void)
{
    i2c_del_driver(&pegatron_fm_6256_bn_f_cpld_driver);
}

MODULE_AUTHOR("Peter5 Lin <Peter5_Lin@pegatroncorp.com.tw>");
MODULE_DESCRIPTION("pegatron_fm_6256_bn_f_cpld driver");
MODULE_LICENSE("GPL");

module_init(pegatron_fm_6256_bn_f_cpld_init);
module_exit(pegatron_fm_6256_bn_f_cpld_exit);
