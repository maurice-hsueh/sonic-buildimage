...
static int pega_fm_6256_bn_f_psu_read(unsigned short addr, u8 reg)
{
             ...
             char *buf)
{
    ...
    data = pega_fm_6256_bn_f_psu_read(client->addr, reg);
...
static struct attribute *pega_fm_6256_bn_f_psu_attributes[] = {
...
static const struct attribute_group pega_fm_6256_bn_f_psu_group = { .attrs = pega_fm_6256_bn_f_psu_attributes};

static void pega_fm_6256_bn_f_psu_add_client(struct i2c_client *client)
{
...
static void pega_fm_6256_bn_f_psu_remove_client(struct i2c_client *client)
{
    struct list_head        *list_node = NULL;
    struct psu_client_node *psu_node = NULL;
    int found = 0;
...
static int pega_fm_6256_bn_f_psu_probe(struct i2c_client *client,
...
{  
    ...
    switch(client->addr)
    {
        case PSU_58_ADDRESS:
        case PSU_59_ADDRESS:
            status = sysfs_create_group(&client->dev.kobj, &pega_fm_6256_bn_f_psu_group);
            break;
        default:
    ...
    pega_fm_6256_bn_f_psu_add_client(client);
...
static int pega_fm_6256_bn_f_psu_remove(struct i2c_client *client)
{
    switch(client->addr)
    {
        case PSU_58_ADDRESS:
        case PSU_59_ADDRESS:
            sysfs_remove_group(&client->dev.kobj, &pega_fm_6256_bn_f_psu_group);
            break;
        default:
    ...
    pega_fm_6256_bn_f_psu_remove_client(client);  
    return 0;
}

static const struct i2c_device_id pega_fm_6256_bn_f_psu_id[] = {
    { "fm_6256_bn_f_psu", 0 },
    {}
};
MODULE_DEVICE_TABLE(i2c, pega_fm_6256_bn_f_psu_id);

static struct i2c_driver pega_fm_6256_bn_f_psu_driver = {
    .class      = I2C_CLASS_HWMON,
    .driver = {
        .name = "pegatron_fm_6256_bn_f_psu",
    },
    .probe      = pega_fm_6256_bn_f_psu_probe,
    .remove     = pega_fm_6256_bn_f_psu_remove,
    .id_table   = pega_fm_6256_bn_f_psu_id,
    .address_list = normal_i2c,
};

static int __init pega_fm_6256_bn_f_psu_init(void)
{
    mutex_init(&list_lock);

    return i2c_add_driver(&pega_fm_6256_bn_f_psu_driver);
}

static void __exit pega_fm_6256_bn_f_psu_exit(void)
{
    i2c_del_driver(&pega_fm_6256_bn_f_psu_driver);
}

MODULE_AUTHOR("Peter5 Lin <Peter5_Lin@pegatroncorp.com.tw>");
MODULE_DESCRIPTION("pega_fm_6256_bn_f_psu driver");
MODULE_LICENSE("GPL");

module_init(pega_fm_6256_bn_f_psu_init);
module_exit(pega_fm_6256_bn_f_psu_exit);
